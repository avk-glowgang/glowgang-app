            ...
            <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="text-center sm:text-left">
                        ...
                        <p className="mt-1.5 text-sm text-gray-500">Ready to level up? 🎉</p>
                    </div>

                    <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
                        <button
                            className="bg-dark-blue hover:bg-dark-blue block rounded-lg px-5 py-3 text-sm font-medium text-white transition focus:outline-none focus:ring"
                            type="button">
                            Upgrade to PRO
                        </button>
