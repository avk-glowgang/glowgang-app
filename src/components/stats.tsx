...
const StatCard: React.FC<StatCardProps> = ({ label, value }) => (
    <div className="flex flex-col rounded border border-gray-100 px-4 py-8 text-center">
        <dt className="text-md order-last font-medium text-gray-500">{label}</dt>
    ...
    <section className="bg-white">
        <div className="mx-auto max-w-5xl px-8 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            <div className="mx-auto max-w-3xl text-center">
                <h2 className="text-2xl font-bold text-black sm:text-3xl ">We are gowing fast! 🚀</h2>

                <p className="mt-4 text-gray-400">Now is the best join to join our community! We are growing fast and we want you to be a part of it.</p>
            </div>
