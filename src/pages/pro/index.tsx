    ...
    return (
        <>
            ...
            <aside className="fixed bottom-4 end-4 z-50 flex items-center justify-center gap-4 rounded-lg bg-black px-5 py-3 text-white">
                ...
                >
                    <span className="font-bold">Congratulations!</span> You're one of the first 50 members to join our PRO membership. Here's a discount code for a 50% off lifetime discount: <span className="font-bold">50GG</span>.
