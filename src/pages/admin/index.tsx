    ...
    return (
        <>
            ...
            <div className="container mx-auto mb-10 mt-10 max-w-5xl px-8">
                ...
                <div className="grid mt-5 grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">

                    <div
                        className="group flex flex-col justify-between rounded-sm bg-white p-4 shadow-xl transition-shadow hover:shadow-lg sm:p-6 lg:p-8"
                    >
                        <div>
                            <h3 className="text-3xl font-bold text-black-600 sm:text-5xl">23</h3>
                    ...
                    >
                        <div>
                            <h3 className="text-3xl font-bold text-pro-600 sm:text-5xl">12</h3>
                    ...
                    >
                        <div>
                            <h3 className="text-3xl font-bold text-pro-600 sm:text-5xl">2</h3>
